...
if ($this->child == null) {
$this->child = new \Nemundo\Content\Data\Content\ContentExternalType($this, "process_content_tree_child");
...
if ($this->parent == null) {
$this->parent = new \Nemundo\Content\Data\Content\ContentExternalType($this, "process_content_tree_parent");
